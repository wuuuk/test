      ...
      <CouponStyle>
        <div>
          ...
          <RowBetween>
            ...
            {reclaim > 0 && <Reclaim>{reclaim.toFixed(6)} to reclaim</Reclaim>}
          </RowBetween>
        </div>
        <div>
      ...
      {!hasApprove ? (
        ...
        <AutoRow justify="center">
            {lpStakeValue && parseFloat(lpStakeValue) > 0 ? <Button width="100%" variant="gradual" onClick={onClaim}>Claim</Button> :
              <Button width="100%" disabled variant="tertiary">Nothing to Claim</Button>}
        </AutoRow>
      )}
      <div className="tips">You'll be refunded any excess tokens when you claim</div>
    </>)}
