import { ChainId, JSBI, Percent, Token, WETH } from '@keyneswap-libs/sdk'

export const ROUTER_ADDRESS = '0x3acfC55f2a07a3faC7Ee5c6312ccE3B07d577a83'
...
export const WOKT = new Token(ChainId.MAINNET, WETH[ChainId.OKT].address, 18, 'WOKT', 'Wrapped OKT')
