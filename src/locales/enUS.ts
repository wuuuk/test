...
const locale = {
  ...
  'home.Search': 'Search',
  'home.SearchKeyneSwap': 'Search KeyneSwap',
  'home.SearchPairsAndTokens': 'Search pairs and tokens...',
  'home.SearchKeyneSwapPairsAndTokens': 'Search KeyneSwap pairs and tokens...',
  ...
  'swap.selectTokenPlaceholder': 'tokenSearchPlaceholder',
  ...
  'swap.liquidityProviderFeeHint': 'For each trade a 0.2% fee is paid. 0.17% goes to liquidity providers and 0.03% goes to the PancakeSwap treasury.',
  ...
  'farms.multiplierRepresents': 'The multiplier represents the amount of KNS rewards each farm gets.',
  'farms.multiplierNumberRatio': 'For example, if a 1x farm was getting 1 KNS per block, a {number}x farm would be getting {number2} KNS per block.',
  ...
  'pools.OKTPOOLS': 'OKT POOLS',
  'pools.OKTPOOLSInfo': 'Stake OKT to earn new tokens.You can unstake at any time.Rewards are calculated per block.',
  ...
  'ifo.launchProject': 'Launch your project with Keyneswap, Okchain&apos;s most popular AMM program and liquidity provider, to bring your tokens directly to the most active and fast-growing community on Okchain.',
  'ifo.takePartHint': 'How to Take Part',
  'ifo.activateProfile': 'Activate your Profile',
  'ifo.activatePartIFo': 'You’ll need an active PancakeSwap Profile to take part in an IFO!',
  ...
  'supple.feePaid': 'For each trade a 0.3% fee is paid. 0.15% goes to liquidity providers and 0.05% goes to the KeyneSwap treasury and 0.10% goes to burn.',
